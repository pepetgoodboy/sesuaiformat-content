...
const LoginPage = () => {
    ...
    // Inline styles to match the HTML <style> block where Tailwind classes might not suffice or for specific overrides
    // Note: Most styles are converted to Tailwind classes below.

    return (
        <div className="min-h-screen flex flex-col relative overflow-hidden selection:bg-orange-500 selection:text-white font-sans transition-colors duration-300" style={{ backgroundColor: 'var(--bg-body)', color: 'var(--text-main)' }}>
            <Toast toasts={toasts} />
            ...
            <main className="flex-grow flex items-center justify-center p-4 sm:p-6 relative z-10">
                <div className="w-full max-w-[480px] animate-[slideUp_0.6s_ease-out_forwards]">
                    ...
                    <div className="text-center mb-8">
                        <div className="inline-flex items-center justify-center w-16 h-16 bg-white/5 rounded-2xl border border-white/10 shadow-lg backdrop-blur-sm p-3 mb-4 mx-auto">
                            <img src="/logo.png" alt="Logo" className="w-full h-full" />
                        </div>
                        <h1 className="text-3xl font-bold font-sans mb-2" style={{ color: 'var(--text-main)' }}>
                            Selamat Datang Kembali
                        </h1>
                        <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
                            Masuk untuk mengelola <span className="text-orange-500 font-semibold">Content Script Engine</span> Anda.
                        </p>
                    </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-xs text-slate-600 font-medium font-plus-jakarta">
